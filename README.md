...
2. Copy `config.example.js` to `config.js` (or edit the existing `config.js`) and paste your key into `GEMINI_API_KEY`. This file is gitignored — your key never gets pushed.
